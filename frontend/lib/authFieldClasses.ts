...
export const authPrimaryBtn =
  "w-full rounded-md bg-[#1A91FF] py-3.5 text-base font-semibold text-white transition hover:bg-[#1580e6] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1A91FF] disabled:cursor-not-allowed disabled:opacity-60";
