...
export function ExploreIconLearning({ className }: IconProps) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 20 20" aria-hidden>
      <path
        fill="currentColor"
...
export function ExploreIconInsights({ className }: IconProps) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24" aria-hidden>
      <path
        fill="currentColor"
...
export function ExploreIconFindFriends({ className }: IconProps) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24" aria-hidden>
      <path
        fill="currentColor"
...
export function ExploreIconBookmarks({ className }: IconProps) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24" aria-hidden>
      <path
        fill="currentColor"
...
export function ExploreIconGroup({ className }: IconProps) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" aria-hidden>
      <path stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2" />
      <circle cx="9" cy="7" r="4" stroke="currentColor" strokeWidth="2" />
      <path stroke="currentColor" strokeWidth="2" d="M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75" />
    </svg>
  );
}

export function ExploreIconGaming({ className }: IconProps) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24" aria-hidden>
      <path
        fill="currentColor"
...
export function ExploreIconSettings({ className }: IconProps) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" aria-hidden>
      <path
        fill="currentColor"
...
export function ExploreIconSavePost({ className }: IconProps) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 24" fill="none" aria-hidden>
      <path
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      ...
      />
      <path stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" d="M17 21v-8H7v8M7 3v5h8" />
    </svg>
  );
}

const byId: Record<string, (p: IconProps) => ReactElement> = {
  "1": ExploreIconLearning,
  "2": ExploreIconInsights,
  "3": ExploreIconFindFriends,
  "4": ExploreIconBookmarks,
  "5": ExploreIconGroup,
  "6": ExploreIconGaming,
  "7": ExploreIconSettings,
  "8": ExploreIconSavePost,
};

export function ExploreIconForItem({ id, className }: { id: string; className?: string }) {
  const Cmp = byId[id] ?? ExploreIconLearning;
