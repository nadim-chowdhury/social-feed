      ...
      <ul className="mx-auto flex max-w-lg items-center justify-between gap-1">
          ...
          >
            ...
            >
              <path
                ...
                fillOpacity="0.6"
                fillRule="evenodd"
                d="M13.334 12.405h.138l.31.001c2.364.015 7.768.247 7.768 3.81 0 3.538-5.215 3.769-7.732 3.784h-.932c-2.364-.015-7.77-.247-7.77-3.805 0-3.543 5.405-3.774 7.77-3.789l.31-.001h.138z"
                clipRule="evenodd"
              />
            </svg>
        ...
        <li className="relative flex-1">
          ...
          >
            ...
            <span className="absolute right-2 top-0 flex h-[16px] min-w-[16px] items-center justify-center rounded-full bg-[#FF4D4F] px-1 text-[10px] font-semibold text-white">
              6
            </span>
