...
Required functionalities:
      ...
      3. Display like/unlike state correctly.

      4. Implement comments, replies, and their like/unlike system.

      5. Show who has liked a post, comment, or reply.

      6. Support private and public posts:
...
Things to Consider
            ...
            3. Design the system assuming millions of posts and reads.
...
Deliverables
               ...
               3. If possible (recommended), deploy the application to a live server and provide the live URL.
